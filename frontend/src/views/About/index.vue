      ...
      <div class="hero-content">
        <div class="hero-text">
          ...
          <p class="hero-description">
            聚焦A股单股分析，集成多智能体协作、新闻质量评估、多LLM配置和报告导出。
            以前后端完整链路呈现一个适合简历展示的智能投研系统。
          </p>
    ...
    <div class="features-section">
      ...
      <div class="features-grid">
        ...
        <div class="feature-card">
          ...
          <p>聚合A股相关新闻，进行质量过滤、相关性评估和情绪辅助分析</p>
          <div class="feature-tags">
            <el-tag size="small" type="success">新闻过滤</el-tag>
            <el-tag size="small" type="success">相关性评估</el-tag>
          </div>
        </div>
        ...
        <div class="feature-card">
          ...
          <p>保留模型配置、数据源配置、缓存管理、数据库管理、日志、同步任务和使用统计</p>
          <div class="feature-tags">
            <el-tag size="small" type="warning">Redis</el-tag>
            <el-tag size="small" type="warning">MongoDB</el-tag>
          </div>
        </div>
        ...
        <div class="origin-card">
          ...
          <div class="origin-description">
            ...
            <ul class="origin-improvements">
              ...
              <li>
                <el-icon class="check-icon"><CircleCheck /></el-icon>
                <span><strong>单股报告链路：</strong>支持A股单股分析、报告沉淀和多格式导出</span>
              </li>
              <li>
                <el-icon class="check-icon"><CircleCheck /></el-icon>
