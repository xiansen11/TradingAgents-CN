  ...
  <div class="login-page">
    <div class="login-container">
      <div class="login-header">
        ...
        <p class="subtitle">A股单股智能分析与报告生成平台</p>
      </div>
      ...
      <div class="login-footer">
        ...
        <p class="disclaimer">
          TradingAgents-CN 是一个 AI 多智能体 A股分析演示系统。平台中的分析结论、观点和“投资建议”均由 AI 自动生成，仅用于学习、研究与交流，不构成任何形式的投资建议或承诺。用户据此进行的任何投资行为及其产生的风险与后果，均由用户自行承担。市场有风险，入市需谨慎。
        </p>
      </div>
    </div>
  </div>
