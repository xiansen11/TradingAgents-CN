...
async def init_providers():
    ...
    providers_data = [
        ...
        },
        {
            ...
            "description": "AIHubMix 深度适配 OpenAI、Claude、Gemini、DeepSeek、智谱、千问 等全球顶级模型，多模型交叉验证，分析结论更可靠；稳定支持 A股智能分析与报告生成；内置 coding-glm-5.1-free 等多款免费模型，零成本体验 AI 分析；按量计费、价格透明，长期使用性价比远超单一厂商。",
